...
func (_CErc20 *CErc20Caller) Implementation(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _CErc20.contract.Call(opts, &out, "implementation")
...
//
// Solidity: function implementation() view returns(address)
func (_CErc20 *CErc20Session) Implementation() (common.Address, error) {
	return _CErc20.Contract.Implementation(&_CErc20.CallOpts)
}

// Implementation is a free data retrieval call binding the contract method 0x5c60da1b.
//
// Solidity: function implementation() view returns(address)
func (_CErc20 *CErc20CallerSession) Implementation() (common.Address, error) {
	return _CErc20.Contract.Implementation(&_CErc20.CallOpts)
}
...
func (_CErc20 *CErc20Transactor) BecomeImplementation(opts *bind.TransactOpts, data []byte) (*types.Transaction, error) {
	return _CErc20.contract.Transact(opts, "_becomeImplementation", data)
}

// BecomeImplementation is a paid mutator transaction binding the contract method 0x56e67728.
//
// Solidity: function _becomeImplementation(bytes data) returns()
func (_CErc20 *CErc20Session) BecomeImplementation(data []byte) (*types.Transaction, error) {
	return _CErc20.Contract.BecomeImplementation(&_CErc20.TransactOpts, data)
}

// BecomeImplementation is a paid mutator transaction binding the contract method 0x56e67728.
//
// Solidity: function _becomeImplementation(bytes data) returns()
func (_CErc20 *CErc20TransactorSession) BecomeImplementation(data []byte) (*types.Transaction, error) {
	return _CErc20.Contract.BecomeImplementation(&_CErc20.TransactOpts, data)
}
...
func (_CErc20 *CErc20Transactor) ResignImplementation(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CErc20.contract.Transact(opts, "_resignImplementation")
}

// ResignImplementation is a paid mutator transaction binding the contract method 0x153ab505.
//
// Solidity: function _resignImplementation() returns()
func (_CErc20 *CErc20Session) ResignImplementation() (*types.Transaction, error) {
	return _CErc20.Contract.ResignImplementation(&_CErc20.TransactOpts)
}

// ResignImplementation is a paid mutator transaction binding the contract method 0x153ab505.
//
// Solidity: function _resignImplementation() returns()
func (_CErc20 *CErc20TransactorSession) ResignImplementation() (*types.Transaction, error) {
	return _CErc20.Contract.ResignImplementation(&_CErc20.TransactOpts)
}
