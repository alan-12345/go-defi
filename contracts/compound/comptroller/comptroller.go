...
// IsBorrowGuardianPaused is a free data retrieval call binding the contract method 0xe6653f3d.
//
// Solidity: function _borrowGuardianPaused() view returns(bool)
func (_Comptroller *ComptrollerCaller) IsBorrowGuardianPaused(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
...
//
// Solidity: function _borrowGuardianPaused() view returns(bool)
func (_Comptroller *ComptrollerSession) IsBorrowGuardianPaused() (bool, error) {
	return _Comptroller.Contract.IsBorrowGuardianPaused(&_Comptroller.CallOpts)
}

// IsBorrowGuardianPaused is a free data retrieval call binding the contract method 0xe6653f3d.
//
// Solidity: function _borrowGuardianPaused() view returns(bool)
func (_Comptroller *ComptrollerCallerSession) IsBorrowGuardianPaused() (bool, error) {
	return _Comptroller.Contract.IsBorrowGuardianPaused(&_Comptroller.CallOpts)
}

// IsMintGuardianPaused is a free data retrieval call binding the contract method 0x3c94786f.
//
// Solidity: function _mintGuardianPaused() view returns(bool)
func (_Comptroller *ComptrollerCaller) IsMintGuardianPaused(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
...
//
// Solidity: function _mintGuardianPaused() view returns(bool)
func (_Comptroller *ComptrollerSession) IsMintGuardianPaused() (bool, error) {
	return _Comptroller.Contract.IsMintGuardianPaused(&_Comptroller.CallOpts)
}

// IsMintGuardianPaused is a free data retrieval call binding the contract method 0x3c94786f.
//
// Solidity: function _mintGuardianPaused() view returns(bool)
func (_Comptroller *ComptrollerCallerSession) IsMintGuardianPaused() (bool, error) {
	return _Comptroller.Contract.IsMintGuardianPaused(&_Comptroller.CallOpts)
}
...
//
// Solidity: function markets(address ) view returns(bool isListed, uint256 collateralFactorMantissa, bool isComped, uint8 version)
func (_Comptroller *ComptrollerCaller) Markets(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.Version = *abi.ConvertType(out[3], new(uint8)).(*uint8)
